                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('motivate')" :active="route().current('motivate')">
                                    Motivate
                                </NavLink>
                                <NavLink :href="route('recordatorios')" :active="route().current('recordatorios')">
                                    Recordatorios
                                </NavLink>
                                <NavLink :href="route('dashboard')" :active="route().current('dashboard')">
                                    Gestión de llamadas
                                </NavLink>
                                <NavLink :href="route('gestionar')" :active="route().current('gestionar')">
                                    Por gestionar
                                </NavLink>
                                <NavLink :href="route('postventa')" :active="route().current('postventa')">
                                    Post-Venta
                                </NavLink>
